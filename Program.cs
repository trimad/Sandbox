            ...
            foreach (string a in args)
            {
                ...
                switch (a)
                {
                    ...
                    case "burningship": //fractal
                        ...
                        hasFractalData = false;
                        break;
                    case "cubic-burning-ship": //fractal
                        fractal = new CubicBurningShip(settings.Width, settings.Height, settings.Bailout, settings.Highest)
                            .Init(settings.MinReal, settings.MaxReal, settings.MinImaginary, settings.MaxImaginary);
                        hasFractalData = false;
                        break;
                    case "quartic-burning-ship": //fractal
                        fractal = new QuarticBurningShip(settings.Width, settings.Height, settings.Bailout, settings.Highest)
                            .Init(settings.MinReal, settings.MaxReal, settings.MinImaginary, settings.MaxImaginary);
                        hasFractalData = false;
                        break;
                    case "buffalo": //fractal
                        fractal = new Buffalo(settings.Width, settings.Height, settings.Bailout, settings.Highest)
                            .Init(settings.MinReal, settings.MaxReal, settings.MinImaginary, settings.MaxImaginary);
                        hasFractalData = false;
                        break;
                    ...
                    case "multibrot3": //fractal
                        ...
                        hasFractalData = false;
                        break;
                    case "multibrot4": //fractal
                        fractal = new Multibrot(settings.Width, settings.Height, settings.Highest, 4)
                            .Init(-1.2, 1.2, -1.2, 1.2);
                        hasFractalData = false;
                        break;
                    case "quintic-multibrot": //fractal
                        fractal = new QuinticMultibrot(settings.Width, settings.Height, settings.Bailout, settings.Highest)
                            .Init(settings.MinReal, settings.MaxReal, settings.MinImaginary, settings.MaxImaginary);
                        hasFractalData = false;
                        break;
                    case "sextic-multibrot": //fractal
                        fractal = new SexticMultibrot(settings.Width, settings.Height, settings.Bailout, settings.Highest)
                            .Init(settings.MinReal, settings.MaxReal, settings.MinImaginary, settings.MaxImaginary);
                        hasFractalData = false;
                        break;
                    case "septic-multibrot": //fractal
                        fractal = new SepticMultibrot(settings.Width, settings.Height, settings.Bailout, settings.Highest)
                            .Init(settings.MinReal, settings.MaxReal, settings.MinImaginary, settings.MaxImaginary);
                        hasFractalData = false;
                        break;
                    case "octic-multibrot": //fractal
                        fractal = new OcticMultibrot(settings.Width, settings.Height, settings.Bailout, settings.Highest)
                            .Init(settings.MinReal, settings.MaxReal, settings.MinImaginary, settings.MaxImaginary);
                        hasFractalData = false;
                        break;
                    case "nonic-multibrot": //fractal
                        fractal = new NonicMultibrot(settings.Width, settings.Height, settings.Bailout, settings.Highest)
                            .Init(settings.MinReal, settings.MaxReal, settings.MinImaginary, settings.MaxImaginary);
                        hasFractalData = false;
                        break;
                    case "decic-multibrot": //fractal
                        fractal = new DecicMultibrot(settings.Width, settings.Height, settings.Bailout, settings.Highest)
                            .Init(settings.MinReal, settings.MaxReal, settings.MinImaginary, settings.MaxImaginary);
                        hasFractalData = false;
                        break;
                    case "undecic-multibrot": //fractal
                        fractal = new UndecicMultibrot(settings.Width, settings.Height, settings.Bailout, settings.Highest)
                            .Init(settings.MinReal, settings.MaxReal, settings.MinImaginary, settings.MaxImaginary);
                        hasFractalData = false;
                        break;
                    case "duodecic-multibrot": //fractal
                        fractal = new DuodecicMultibrot(settings.Width, settings.Height, settings.Bailout, settings.Highest)
                            .Init(settings.MinReal, settings.MaxReal, settings.MinImaginary, settings.MaxImaginary);
                        hasFractalData = false;
                        break;
                    case "tredecic-multibrot": //fractal
                        fractal = new TredecicMultibrot(settings.Width, settings.Height, settings.Bailout, settings.Highest)
                            .Init(settings.MinReal, settings.MaxReal, settings.MinImaginary, settings.MaxImaginary);
                        hasFractalData = false;
                        break;
                    case "tetradecic-multibrot": //fractal
                        fractal = new TetradecicMultibrot(settings.Width, settings.Height, settings.Bailout, settings.Highest)
                            .Init(settings.MinReal, settings.MaxReal, settings.MinImaginary, settings.MaxImaginary);
                        hasFractalData = false;
                        break;
                    case "quindecic-multibrot": //fractal
                        ...
                        hasFractalData = false;
                        break;
                    case "hexadecic-multibrot": //fractal
                        fractal = new HexadecicMultibrot(settings.Width, settings.Height, settings.Bailout, settings.Highest)
                            .Init(settings.MinReal, settings.MaxReal, settings.MinImaginary, settings.MaxImaginary);
                        hasFractalData = false;
                        break;
                    case "heptadecic-multibrot": //fractal
                        fractal = new HeptadecicMultibrot(settings.Width, settings.Height, settings.Bailout, settings.Highest)
                            .Init(settings.MinReal, settings.MaxReal, settings.MinImaginary, settings.MaxImaginary);
                        hasFractalData = false;
                        break;
                    case "octadecic-multibrot": //fractal
                        fractal = new OctadecicMultibrot(settings.Width, settings.Height, settings.Bailout, settings.Highest)
                            .Init(settings.MinReal, settings.MaxReal, settings.MinImaginary, settings.MaxImaginary);
                        hasFractalData = false;
                        break;
                    case "newton": //fractal
                    ...
                    case "perpendicular-mandelbrot": //fractal
                        ...
                        hasFractalData = false;
                        break;
                    case "perpendicular-burningship": //fractal
                        fractal = new PerpendicularBurningShip(settings.Width, settings.Height, settings.Bailout, settings.Highest)
                            .Init(settings.MinReal, settings.MaxReal, settings.MinImaginary, settings.MaxImaginary);
                        hasFractalData = false;
                        break;
                    ...
                    case "/?":
                        ...
                        Console.WriteLine(String.Format("{0,-24} {1}", "quartic-burning-ship", "Render the Quartic Burning Ship fractal"));
                        ...
                        Console.WriteLine(String.Format("{0,-24} {1}", "quintic-multibrot", "Render the Quintic Multibrot / degree-5 Mandelbrot-family fractal"));
                        Console.WriteLine(String.Format("{0,-24} {1}", "sextic-multibrot", "Render the Sextic Multibrot / degree-6 Mandelbrot-family fractal"));
                        Console.WriteLine(String.Format("{0,-24} {1}", "septic-multibrot", "Render the Septic Multibrot / degree-7 Mandelbrot-family fractal"));
                        Console.WriteLine(String.Format("{0,-24} {1}", "octic-multibrot", "Render the Octic Multibrot / degree-8 Mandelbrot-family fractal"));
                        Console.WriteLine(String.Format("{0,-24} {1}", "nonic-multibrot", "Render the Nonic Multibrot / degree-9 Mandelbrot-family fractal"));
                        Console.WriteLine(String.Format("{0,-24} {1}", "decic-multibrot", "Render the Decic Multibrot / degree-10 Mandelbrot-family fractal"));
                        Console.WriteLine(String.Format("{0,-24} {1}", "undecic-multibrot", "Render the Undecic Multibrot / degree-11 Mandelbrot-family fractal"));
                        ...
                        Console.WriteLine(String.Format("{0,-24} {1}", "hexadecic-multibrot", "Render the Hexadecic Multibrot / degree-16 Mandelbrot-family fractal"));
                        Console.WriteLine(String.Format("{0,-24} {1}", "heptadecic-multibrot", "Render the Heptadecic Multibrot / degree-17 Mandelbrot-family fractal"));
                        Console.WriteLine(String.Format("{0,-24} {1}", "octadecic-multibrot", "Render the Octadecic Multibrot / degree-18 Mandelbrot-family fractal"));
